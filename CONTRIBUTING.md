...
1. Clone the repository you forked
    ...
    $ git clone https://gitlab.com/<YOUR_USERNAME>/nsslab-thesis-template
    # Navigate to the newly cloned directory
    $ cd nsslab-thesis-template
    ```
...
3. Assign the original repository to a remote called `upstream` and update
    ...
    $ git remote add upstream https://gitlab.com/nsslab/nsslab-thesis-template
